...
namespace Simbirsoft.API.Infrastructure.Services
{
	...
	public class JwtAuthManager : IJwtAuthManager
    {
        ...
        /// <inheritdoc />
        public JwtAuthResponse GenerateTokens(string username, Claim[] claims, DateTime now)
        {
        ...
        /// <inheritdoc />
        public JwtAuthResponse Refresh(string refreshToken, string accessToken, DateTime now)
        {
