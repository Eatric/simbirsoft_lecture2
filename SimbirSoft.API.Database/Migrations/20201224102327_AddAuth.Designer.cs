...
namespace SimbirSoft.API.Database.Migrations
{
    ...
    [Migration("20201224102327_AddAuth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimbirSoft.API.Database.Domain.Role", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SimbirSoft.API.Database.Domain.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SimbirSoft.API.Database.Domain.UserRoles", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SimbirSoft.API.Database.Domain.Role", b =>
                {
                    b.HasOne("SimbirSoft.API.Database.Domain.User", null)
                        .WithMany("Roles")
            ...
            modelBuilder.Entity("SimbirSoft.API.Database.Domain.UserRoles", b =>
                {
                    b.HasOne("SimbirSoft.API.Database.Domain.User", "Entity1")
                        .WithMany()
                        .HasForeignKey("Entity1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SimbirSoft.API.Database.Domain.Role", "Entity2")
                        .WithMany()
                        .HasForeignKey("Entity2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
